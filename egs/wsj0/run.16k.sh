...
data=/home/users/zge/data1/datasets/WSJ0/wav16k/min

stage=1  # Modify this to control to start from which stage
# -- END

dumpdir=data/16k  # directory to put generated json file
...
# minibatch
shuffle=1
batch_size=4 # #samples per GPU: batch_size/#gpus
num_workers=4
# optimizer
optimizer=adam
lr=1e-3
...
if [ $stage -le 2 ]; then
  ...
  # continue_from=$expdir/ckpt.ep11.pth
  model_dir=models/16k
  continue_from=$model_dir/ckpt.ep15.pth
